...
export const categoryService = {
  ...
  createCategory: async (categoryInput) => {
    ...
    if (error) {
      console.error('[Kreatorstore - CategoryService] Error creating category:', error);
  ...
  updateCategory: async (categoryId, updateInput) => {
    ...
    if (error) {
      console.error('[Kreatorstore - CategoryService] Error updating category:', error);
  ...
  deleteCategory: async (categoryId) => {
    ...
    if (error) {
      console.error('[Kreatorstore - CategoryService] Error deleting category:', error);
  ...
  updateCategoriesOrder: async (categoriesList) => {
    ...
    try {
      ...
      console.error('[Kreatorstore - CategoryService] Error updating categories sort order:', e);
      throw e;
    }
  }
};
