...
export default async function sitemap() {
  const baseUrl = 'https://kreatorstore.com';
  ...
  try {
    ...
    for (const store of stores) {
      ...
      try {
        ...
        console.error(`[Kreatorstore - Sitemap] Error fetching products for store ${store.id}:`, prodErr);
      }
    }
  } catch (storeErr) {
    console.error('[Kreatorstore - Sitemap] Error fetching stores for sitemap:', storeErr);
  }
