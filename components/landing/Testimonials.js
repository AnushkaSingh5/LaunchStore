  ...
  const reviews = [
    {
      ...
      avatar: '👩‍🎨',
      review: 'I launched Luxe Apparel in just one evening. Kreatorstore handles the checkout, shipping rates, and product variations flawlessly. My weekly sales have doubled since moving off WordPress.'
    },
    {
      name: 'David L.',
